...
function scr_fillGrid(ax, ay, xgoal, ygoal){
...
if (ds_grid_get(ds_gridpathfinding,ax+1,ay)==-2 && ds_grid_get(ds_gridpathfinding,ax+1,ay-1)==-1)
	...
	//two blocks vertically right side
...
/// Check if the enemy can do a diagonal jump (Big Jump). (Right side);
	...
	if ds_grid_get(ds_gridpathfinding,ax+1,ay)==-1 && ds_grid_get(ds_gridpathfinding,ax+2,ay)==-1 && ds_grid_get(ds_gridpathfinding,ax+2,ay+1)==-2
			...
			///Check if the enemy can jump horizontally 2 (jump over a void). (Right side)
	if ds_grid_get(ds_gridpathfinding,ax+1,ay)==-1 && ds_grid_get(ds_gridpathfinding,ax+2,ay)==-1 && ds_grid_get(ds_gridpathfinding,ax+3,ay)==-1 && ds_grid_get(ds_gridpathfinding,ax+3,ay+1)==-2
	        {
